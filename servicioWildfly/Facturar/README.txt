...
a persistence unit "FacturarPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Facturar\pom.xml":
...
artifact ("Facturar.war") is already built. You can build
